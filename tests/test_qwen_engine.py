...
from pagedmark.qwen_engine import (
    _ALPHA_HEIGHT_FRAC,
    _ALPHA_WIDTH_FRAC,
    _LADDER,
    QwenEngine,
...
class TestConfig:
    def test_per_mark_ladder_and_shared_default_untouched(self):
        ...
        from pagedmark.doubao_engine import _CONFIG as db
        from pagedmark.jimeng_engine import _CONFIG as jm
        from pagedmark.samsung_engine import _CONFIG as ss

...
class TestHasAiMetadata:
    ...
    def test_strip_c2pa_boxes_removes_uuid_box(self, tmp_path: Path):
        ...
        from pagedmark._internal.isobmff import strip_c2pa_boxes
        from pagedmark.metadata import C2PA_UUID
    ...
    def test_remove_ai_metadata_strips_c2pa_in_avif(self, tmp_path: Path):
        ...
        from pagedmark.metadata import C2PA_UUID, remove_ai_metadata
...
class TestSamsungGenai:
    ...
    def test_non_samsung_trailer_preserved(self, tmp_path: Path):
        ...
        from pagedmark.metadata import _strip_samsung_trailer
...
class TestAIGCLabel:
    ...
    def _aigc_png(self, tmp_path: Path, label: str = "1", producer: str = "TESTPRODUCER001") -> Path:
        from pagedmark.metadata import aigc_label  # noqa: F401  (import-time guard)
    ...
    def test_scan_head_collects_png_metadata_past_window(self, tmp_path: Path):
        ...
        from pagedmark.metadata import _png_late_metadata, scan_head
    ...
    def test_scan_head_collects_webp_metadata_past_window(self, tmp_path: Path):
        ...
        from pagedmark.metadata import _riff_late_metadata, scan_head
    ...
    def test_riff_late_metadata_ignores_the_coded_image(self, tmp_path: Path):
        ...
        from pagedmark.metadata import _riff_late_metadata
...
class TestHuggingFaceJob:
    ...
    def test_returns_job_id(self, tmp_path: Path):
        from pagedmark.metadata import huggingface_job
    ...
    def test_remove_strips_hf_job(self, tmp_path: Path):
        from pagedmark.metadata import huggingface_job, remove_ai_metadata
...
class TestSoftBinding:
    ...
    def test_vendors_in_recognizes_known_algs(self):
        from pagedmark._internal.c2pa import soft_binding_vendors_in
...
class TestLateProvenanceBox:
    ...
    def test_scan_c2pa_region_finds_late_box(self, tmp_path: Path):
        from pagedmark._internal.isobmff import scan_c2pa_region
        from pagedmark.metadata import C2PA_UUID
    ...
    def test_scan_head_includes_late_box(self, tmp_path: Path):
        from pagedmark.metadata import C2PA_UUID, scan_head
...
class TestC2paCloudManifest:
    ...
    def test_detects_adobe_cloud_manifest(self, tmp_path: Path):
        from pagedmark.metadata import c2pa_cloud_manifest
...
def test_remove_all_bypasses_lossless_jpeg(tmp_path, monkeypatch):
    ...
    # re-encode strip (#7).
    import pagedmark.metadata as md

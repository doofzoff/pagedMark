...
from pagedmark.humanizer import apply_analog_humanizer, unsharp_mask
...
class TestAdaptivePolish:
    ...
    def test_noop_when_already_sharp(self):
        from pagedmark.humanizer import adaptive_polish
    ...
    def test_sharpens_a_soft_image_toward_reference(self):
        ...
        from pagedmark.humanizer import _laplacian_variance, adaptive_polish
    ...
    def test_mask_spares_edges(self):
        from pagedmark.humanizer import _smooth_grain_mask
    ...
    def test_all_edges_reference_grain_mask_near_zero(self):
        ...
        from pagedmark.humanizer import _smooth_grain_mask, adaptive_polish

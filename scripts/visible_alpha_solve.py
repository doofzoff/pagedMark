...
_SPECS: dict[str, EngineSpec] = {
    "doubao": EngineSpec(
        ...
        _ROOT / "src" / "pagedmark" / "assets" / "doubao_alpha.png",
    ),
    "jimeng": EngineSpec(
        "jimeng",
        ...
        _ROOT / "src" / "pagedmark" / "assets" / "jimeng_alpha.png",
    ),
    "samsung": EngineSpec(
        "samsung",
        ...
        _ROOT / "src" / "pagedmark" / "assets" / "samsung_alpha.png",
...
_GEMINI_ASSETS: dict[int, Path] = {
    96: _ROOT / "src" / "pagedmark" / "assets" / "gemini_bg_96.png",
    48: _ROOT / "src" / "pagedmark" / "assets" / "gemini_bg_48.png",
}

...
def build_config(
    ...
    from pagedmark._text_mark_engine import TextMarkConfig
    from pagedmark.doubao_engine import _CONFIG
...
def crossfire(
    ...
    from pagedmark.doubao_engine import _CONFIG as db_cfg

...
WHY THIS EXISTS AND WHAT IT IS NOT
  ...
  synthetic inputs. This is the other half: run the real `pagedmark` entry point,
...
def check_visible(res: Results, tmp: Path) -> None:
    ...
    """
    from pagedmark.image_io import imread
    from pagedmark.watermark_registry import detect_marks, get_mark, remove_auto_marks

...
from pagedmark.video_temporal import stabilize_filled_frame
...
if TYPE_CHECKING:
    ...
    from pagedmark.watermark_registry import Backend
...
def encode_clean_video(
    ...
    *,
    ...
    from pagedmark.watermark_registry import fill, resolve_backend

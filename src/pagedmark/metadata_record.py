...
from pagedmark._internal.constants import PNG_SIGNATURE, RIFF_CODED_IMAGE_CHUNKS
...
def _isobmff_regions(image_path: Path, head: bytes) -> bytes:
    ...
    """
    from pagedmark._internal.isobmff import scan_c2pa_region, tc260_aigc_payloads
...
def _container_regions(image_path: Path, head: bytes) -> tuple[str, bytes]:
    ...
    """
    from pagedmark._internal.isobmff import is_isobmff
    from pagedmark.metadata import png_late_metadata, riff_late_metadata
